export const digitalProjects = [
  {
    slug: 'bharattex',
    client: 'BharatTex',
    category: 'Textile Trade Fair · Event Technology · Interactive Visitor Experience',
    title: 'BharatTex',
    overview:
      'Nebuloid designed and deployed a complete digital experience layer for BharatTex — India\'s premier textile trade fair — combining interactive visitor journeys, on-ground engagement systems, and premium event technology that helped exhibitors and attendees navigate, discover, and connect across the venue.',
    image: '/assets/digital-experiences/bharattex/bharattex-hero.jpg',
    contribution: [
      'Interactive Visitor Experience Platform',
      'On-ground Event Technology',
      'Touchscreen Experience Design',
      'Visitor Engagement Systems',
      'Digital Wayfinding Support',
      'UI/UX Design',
    ...
    impact: [
      'Stronger booth participation',
      'Clearer visitor journeys',
      'Higher on-ground engagement',
